...
class PreProcessMangopare(object):
    ...
    def _classify_gear(self):
        ...
        """
        self.logger.error("In preprocess: _classify_gear")
    ...
    def _find_bottom(self, cutoff='4 minutes'):
        ...
        """
        self.logger.error("In preprocess: _find_bottom")
        try:
    ...
    def _add_variable_attrs(self):
        ...
        """
        self.logger.error("In preprocess: _add_variable_attrs")
        try:
    ...
    def _add_global_attrs(self):
        ...
        """
        self.logger.error("In preprocess: _add_global_attrs")
        try:
    ...
    def _set_sitename(self):
        ...
        """
        self.logger.error("In preprocess: _set_sitename")
        try:
